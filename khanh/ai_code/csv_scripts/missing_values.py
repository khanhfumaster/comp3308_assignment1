...
def output_csv(list, headers, tag):
	#todo
	filename = '/Users/khanh/COMP3308/Assignment1/datasets/pima-indians-diabetes-' + tag + '.csv' 
...
def main():
	with open('/Users/khanh/COMP3308/Assignment1/datasets/pima-indians-diabetes.csv', 'rb') as csvfile:
